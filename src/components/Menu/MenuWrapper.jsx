...
const MenuWrapper = ({
  className, isAuthenticated, openModal, logout, history,
}) => {
  const [menu, setMenu] = useState(false);
  return (
    <div className={`${className}`}>
      <button className={menu ? 'menu__logo' : 'menu__logo inactive'} type="button" onClick={() => history.push('/team-will-bank')}> Plantify </button>
