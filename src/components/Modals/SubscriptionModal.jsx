...
const SubscriptionModal = ({ className, modalName, openModal, subscribe }) => {
  ...
  return (
    <PopUp
      visible={modalName === 'email-subscription'}
    ...
    >
      <div className={`${className}`}>
              ...
              <>
                ...
                <div className="birth-date-box">
                  <div className="birth-date-header">
                    ...
                    <p>
                      Pour vous inscrire, vous devez être âgé d'au moins 18 ans.
                      Les autres utilisateurs ne verront pas votre date de
                      naissance.
                    </p>
                  </div>
                  <div className="text-box">
        ...
        <div className="promotion">
          <input type="checkbox" />
          <p>
            Je ne souhaite pas recevoir de messages promotionnels du TeamWill.
            Je peux également désactiver cette option à tout moment dans les
