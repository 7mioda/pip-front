...
const ProductModal = ({
  ...
  <PopUp visible={modalName === 'product'} close={() => openModal('none')}>
    <div className="container">
      ...
      <div className="right">
        ...
        <p>
          ...
          Run is definitely a perfect model for summer. For Spring/Summer 2012 a
          fresh Mint Green colorway's version of this 'yet classic' pair is now
          available to order.
        </p>
